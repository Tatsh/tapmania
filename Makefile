...
OBJS=Util/Texture2D.o Classes/SoundEffectsHolder.o Classes/JoyPad.o Classes/SongsDirectoryCache.o Classes/TapManiaAppDelegate.o Classes/TexturesHolder.o Classes/EAGLView.o Renderers/AbstractRenderer.o Renderers/AbstractMenuRenderer.o Renderers/MainMenuRenderer.o Renderers/UIElements/LifeBar.o  Renderers/UIElements/MenuItem.o Renderers/UIElements/SongPickerMenuItem.o Renderers/SongPlayRenderer.o Renderers/SongPickerMenuRenderer.o Renderers/CreditsRenderer.o Renderers/OptionsMenuRenderer.o Renderers/SongOptionsRenderer.o Renderers/UIElements/TogglerItem.o Objects/TMSong.o Objects/TMSteps.o Objects/TMSongOptions.o Objects/TMNote.o Objects/TMTrack.o Objects/TMTimeBasedChange.o Util/SoundEngine.o Parsers/DWIParser.o Util/TimingUtil.o
