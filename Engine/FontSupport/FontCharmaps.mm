...
static FontCharmaps *sharedCharmapsDelegate = nil;

#define M_SKIP 0xFEFF
 ...
 *
 ...
 pqrstuvwxyz{|}~ 
 */
static const unichar map_ascii[] = {
 ...
 */
static const unichar map_iso_8859_1[] = {
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
        0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002a, 0x002b, 0x002c, 0x002d, 0x002e, 0x002f,
        0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003a, 0x003b, 0x003c, 0x003d, 0x003e, 0x003f,
 ...
 * Non-breaking space and soft hyphen are not used.
 */
static const unichar map_cp1252[] = {
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
        0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B, 0x002C, 0x002D, 0x002E, 0x002F,
        0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, 0x0038, 0x0039, 0x003A, 0x003B, 0x003C, 0x003D, 0x003E, 0x003F,
...
static const unichar map_iso_8859_2[] = {
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
        M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP, M_SKIP,
 ...
 */
static const unichar map_basic_japanese[] =
        {
...
/* Korean Jamo */
static const unichar map_korean_jamo[] =
        {
...
static const unichar map_numbers[] = {
...
- (id)init
{
    ...
    // Store maps
    [m_pCharmaps setObject:ascii forKey:@"ascii"];
    [m_pCharmaps setObject:bJap forKey:@"basic-japanese"];
    [m_pCharmaps setObject:iso8859_1 forKey:@"iso-8859-1"];
    [m_pCharmaps setObject:cp1252 forKey:@"cp1252"];
    [m_pCharmaps setObject:iso8859_2 forKey:@"iso-8859-2"];
    [m_pCharmaps setObject:kJamo forKey:@"korean-jamo"];
    [m_pCharmaps setObject:numbers forKey:@"numbers"];
...
{
    NSString *cmStr = [m_pCharmaps objectForKey:name];
    if (cmStr != nil)
    {
        return cmStr;
    }
...
+ (FontCharmaps *)sharedInstance
{
    @synchronized (self)
    {
        if (sharedCharmapsDelegate == nil)
        {
            [[self alloc] init];
        }
    }
    return sharedCharmapsDelegate;
}
...
+ (id)allocWithZone:(NSZone *)zone
{
    @synchronized (self)
    {
        if (sharedCharmapsDelegate == nil)
        {
            sharedCharmapsDelegate = [super allocWithZone:zone];
            return sharedCharmapsDelegate;
        }
    }
